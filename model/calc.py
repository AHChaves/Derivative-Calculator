...
# Função para solicitar a função ao usuário
def solicitarFuncao():
    funcao = input("Por favor digite uma função f(x): ").lower().replace(" ","")
    return funcao

# Função para separar os monômios da string da função
...
def RetaTangente(num):
    ...
    if valor_funcional_derivada == 1:
        ...
        return "y = {2}{0}{3}".format(variavel, num, valor_funcional_derivada, b)
